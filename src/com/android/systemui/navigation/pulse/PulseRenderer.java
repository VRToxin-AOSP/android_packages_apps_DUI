...
public class PulseRenderer implements Renderer {
    ...
    public void getcustomizations(Context ctx) {
        ...
        if (mFilledBlock == 0) {
            mPathEffect1 = ctx.getResources().getDimensionPixelSize(
        ...
        if (mEmptyBlock  == 0) {
            mPathEffect2 = ctx.getResources().getDimensionPixelSize(
        ...
        if (mCustomDimen == 0) {
            mPaint.setStrokeWidth(ctx.getResources().getDimensionPixelSize(
        ...
        if (mNumDivision == 0) {
            mDivisions = ctx.getResources().getInteger(
                            R.integer.config_pulseDivisions);
        } else if (mNumDivision == 1) {
            mDivisions = ctx.getResources().getInteger(
                            R.integer.config_pulseDivisions1);
        } else if (mNumDivision == 2) {
            mDivisions = ctx.getResources().getInteger(
                            R.integer.config_pulseDivisions2);
        } else if (mNumDivision == 3) {
            mDivisions = ctx.getResources().getInteger(
                            R.integer.config_pulseDivisions3);
        } else if (mNumDivision == 4) {
            mDivisions = ctx.getResources().getInteger(
                            R.integer.config_pulseDivisions4);
        } else if (mNumDivision == 5) {
            mDivisions = ctx.getResources().getInteger(
                            R.integer.config_pulseDivisions5);
        } else if (mNumDivision == 6) {
            mDivisions = ctx.getResources().getInteger(
                            R.integer.config_pulseDivisions6);
        } else if (mNumDivision == 7) {
            mDivisions = ctx.getResources().getInteger(
                            R.integer.config_pulseDivisions7);
        } else if (mNumDivision == 8) {
            mDivisions = ctx.getResources().getInteger(
                            R.integer.config_pulseDivisions8);
        }

        if(mFudgeFactor == 0) {
            mDbFuzzFactor = ctx.getResources().getInteger(
